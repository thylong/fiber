...
func (z *cacheSegments) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	...
	for zb0001 > 0 {
		...
		case "segments":
			...
			if z.segments == nil {
				z.segments = make(map[string]item, zb0002)
...
func (z *cacheSegments) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "segments"
	err = en.Append(0x81, 0xa8, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73)
	if err != nil {
		return
	}
...
func (z *cacheSegments) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "segments"
	o = append(o, 0x81, 0xa8, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73)
...
func (z *cacheSegments) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *cacheSegments) Msgsize() (s int) {
